...
async function getUserMenus(req, res) {
  try {
    ...
    let userSystemId = req.query.systemId ? parseInt(req.query.systemId) : null;

    // Obter id_organization da query param (aceita ambos id_organization e organizationId)
    const userOrganizationId = (req.query.id_organization || req.query.organizationId) 
      ? parseInt(req.query.id_organization || req.query.organizationId) 
      : null;
