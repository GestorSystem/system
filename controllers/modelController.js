...
// Função para obter caminho da pasta de módulos
...
async function createModel(req, res) {
  try {
    ...
    if (module) {
      ...
      const modulePath = path.join(getModulesPath(), module, 'models');
...
async function generateMigration(req, res) {
  try {
    ...
    if (module) {
      ...
      migrationsPath = path.join(getModulesPath(), module, 'migrations');
...
async function generateSeeder(req, res) {
  try {
    ...
    if (module) {
      ...
      seedersPath = path.join(getModulesPath(), module, 'seeders');
