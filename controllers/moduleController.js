...
// Obter caminho da pasta de módulos a partir da variável de ambiente MODULES_FOLDER
// Se não estiver definida, usar o padrão 'modules'
...
async function installModuleFromNpm(req, res) {
  try {
    ...
    if (fs.existsSync(gestorNodeModulesPath)) {
      ...
      // Extrair nome do módulo do packageName (pode ser file: pessoa ou @gestor/pessoa)
...
module.exports = {
  ...
  checkDependencies,
  getModulesPath // Exportar função para uso em outros controllers
};
